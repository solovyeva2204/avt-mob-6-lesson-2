...
abstract public class SearchPageObject extends MainPageObject {
    ...
    {
        this.waitForElementPresent(SEARCH_LINE_CANCEL_BUTTON, "Cannot find search cancel button", 5);
    }

    public void waitForCancelButtonToDisappear()
    {
        this.waitForElementNotPresent(SEARCH_LINE_CANCEL_BUTTON, "Search cancel button is still present", 5);
    }

    public void clickCancelSearch()
    {
        this.waitForElementAndClick(SEARCH_LINE_CANCEL_BUTTON, "Cannot find search and click cancel button", 10);
    }
    ...
    {
        this.assertElementsNotPresent(SEARCH_RESULT_ELEMENT, "We supposed no to find any results");
    }

    public void waitSearchEmptyMessage()
    {
        this.waitForElementPresent(SEARCH_EMPTY_MESSAGE, "Cannot find search empty message", 5);
    }
}
