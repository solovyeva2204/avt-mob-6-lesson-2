...
public class MainPageObject {
    ...
    public WebElement waitForElementAndClick(By by, String error_message, long timeOutAndSeconds)
    {
    ...
    public WebElement waitForElementAndSendKeys(By by, String value, String error_message, long timeOutAndSeconds)
    {
        WebElement element = waitForElementPresent(by, error_message, timeOutAndSeconds);
