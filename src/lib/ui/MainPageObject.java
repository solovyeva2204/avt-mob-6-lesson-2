...
public class MainPageObject {
    ...
    public WebElement waitForElementAndClick(String locator, String error_message, long timeOutAndSeconds)
    {
        WebElement element = waitForElementPresent(locator, error_message, timeOutAndSeconds);
        element.click();
        return element;
    }

    public WebElement waitForElementAndSendKeys(String locator, String value, String error_message, long timeOutAndSeconds)
    {
        WebElement element = waitForElementPresent(locator, error_message, timeOutAndSeconds);
    ...
    public void assertElementsNotPresent(String locator, String error_message)
    {
        ...
        if (amount_of_elements > 0) {
            String default_message = "An element " + locator + "supposed not be to present";
