...
public class ArticlePageObject extends MainPageObject
{
    ...
    {
        return this.waitForElementPresent(By.id(TITLE), "Cannot find article title in page", 20 );
    }
    ...
    public void swipeToFooter()
    {
        this.swipeUpToElement(
                ...
                "Cannot fint the element of article",
                20
        );
    }
    ...
    {
        this.waitForElementPresent(By.xpath(TITLE), "Cannot find title element");
    }
}
